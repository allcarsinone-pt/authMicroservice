...
describe('User entity', () => {
  it('should create a new user', () => {
    const user = User.create({ username: 'johndoe123', name: 'John Doe', email: 'test@test.com', password: '12345678', role_id: 1, id: 'user-id' })
  ...
  it('should throw an error when email is invalid', () => {
    expect(() => User.create({ username: 'johndoe123', name: 'John Doe', email: 'test@test', password: '12345678', role: 'test-role', id: 'user-id' })).toThrow(Error)
  })
})
